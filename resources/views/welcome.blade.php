...
<body>
    ...
    <div class="form-outlane mb-3 mt-2 form-control">
        <input type="email" name="email" id="email" class="form-control" placeholder="Email">
    </div>
    <div class="form-outlane mb-3 form-control">
    ...
    <center> <button type="submit" class="btn btn-primary btn-block mb-3">Sign in</button> </center>
